  ...
  describe 'POST /v3/apps/:guid/actions/apply_manifest' do
    ...
    describe 'audit events' do
      it 'creates audit events including metadata.manifest_triggered' do
        ...
        expect(VCAP::CloudController::Event.all.map(&:type)).to match_array([
        ...
        expect(VCAP::CloudController::Event.map { |event| event.metadata['manifest_triggered'] }).to eq([true] * 9)
      end
    end
